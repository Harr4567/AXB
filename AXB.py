...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[AXB] %s \x1b[1;95m ☆ Your Active Apps ☆     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[AXB] %s \x1b[1;95m ◇ Your Expired Apps ◇    :{WHITE}'%(M))
        for i in range(len(game)):
...
\033[1;37m======================================
\033[1;37m     \033[1;37mCREATED BY\33[0;m   =  \033[1;37mAZAN ALI
\033[1;37m     \033[1;37mFACEBOK      = \033[1;37m AZAN X.
\033[1;37m     \033[1;37mGITHUB       =  \033[1;37mHarr4567
